...
/**
 * Generate placeholder matches for 3-group tournaments
 * Semifinal bracket with one group winner + best 2nd
 */
export function generateThreeGroupPlaceholder(numberOfCourts: number): Match[] {
  const matches: Match[] = [];
  let matchNumber = 1;
