...
import { calculateShortMainRoundPlacements } from '../shortMainRound';
    ...
    const matches: Match[] = [
      {
        ...
        scores: [{ teamA: 21, teamB: 15 }], winnerId: teams[0].id, status: 'completed', knockoutRound: 'top-semifinal',
      },
      {
        id: '2', round: 1, matchNumber: 2, teamAId: teams[2].id, teamBId: teams[3].id, courtNumber: 2,
        scores: [{ teamA: 21, teamB: 18 }], winnerId: teams[2].id, status: 'completed', knockoutRound: 'top-semifinal',
      },
      {
        id: '3', round: 2, matchNumber: 3, teamAId: teams[0].id, teamBId: teams[2].id, courtNumber: 1,
        scores: [{ teamA: 21, teamB: 19 }], winnerId: teams[0].id, status: 'completed', knockoutRound: 'top-final', playoffForPlace: 1,
      },
      {
        id: '4', round: 2, matchNumber: 4, teamAId: teams[1].id, teamBId: teams[3].id, courtNumber: 2,
        scores: [{ teamA: 21, teamB: 15 }], winnerId: teams[1].id, status: 'completed', knockoutRound: 'third-place', playoffForPlace: 3,
      },
    ];
